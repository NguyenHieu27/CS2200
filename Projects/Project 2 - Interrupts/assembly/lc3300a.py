...
"""lc3300a.py: A definition of the LC-3300a architecture."""
...
class fabs(Instruction):
    __RE_FABS = re.compile(r'^\s*(?P<RX>\$\w+?)\s*$')
    ...
    @classmethod
    def parse_operands(cls, operands, pc, instruction):
        match = cls.__RE_FABS.match(operands)
        ...
        result_list.append(parse_register(match.group('RX')))
        result_list.append('0' * FABS_UNUSED_SIZE)
